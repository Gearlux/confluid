...
from confluid import load, resolve_config_path, set_app_name
...
def main() -> None:
    with tempfile.TemporaryDirectory() as tmp:
        ...
        assert load("experiment.yaml", until="raw")["who"] == "cwd_config"
        print(f"./config/ shadows XDG: who={load('experiment.yaml', until="raw")['who']}")
